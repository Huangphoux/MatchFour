...
namespace QuanLyMachTu
{
    partial class BenhNhanControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            label1 = new Label();
            textBox_TKUpload_MaTK = new TextBox();
            label18 = new Label();
            label15 = new Label();
            label16 = new Label();
            textBox_TKUpload_TenTK = new TextBox();
            ...
            label19 = new Label();
            comboBox_HSBAUpload_Thang = new ComboBox();
            label20 = new Label();
            textBox_HSBAUpload_Ngay = new TextBox();
            label21 = new Label();
            label22 = new Label();
            label23 = new Label();
            textBox_HSBAUpload_MaNV = new TextBox();
            button_HSBAUpload_OK = new Button();
            ...
            label32 = new Label();
            label33 = new Label();
            textBox_HSBAFilter_Nam = new TextBox();
            comboBox_HSBAFilter_Thang = new ComboBox();
            textBox_HSBAFilter_Ngay = new TextBox();
            comboBox_HSBAFilter_Operation = new ComboBox();
            label25 = new Label();
            label26 = new Label();
            label29 = new Label();
            label30 = new Label();
            textBox_HSBAFilter_MaHSBA = new TextBox();
            textBox_HSBAFilter_SDT = new TextBox();
            textBox_HSBAFilter_Email = new TextBox();
            button_HSBAFilter_OK = new Button();
            ...
            label36 = new Label();
            label37 = new Label();
            textBox_TKFilter_Nam = new TextBox();
            comboBox_TKFilter_Thang = new ComboBox();
            textBox_TKFilter_Ngay = new TextBox();
            comboBox_TKFilter_Operation = new ComboBox();
            label38 = new Label();
            label39 = new Label();
            label40 = new Label();
            label41 = new Label();
            label42 = new Label();
            textBox_TKFilter_MaTK = new TextBox();
            textBox_TKFilter_SDT = new TextBox();
            textBox_TKFilter_Email = new TextBox();
            textBox_TKFilter_TenTK = new TextBox();
            ...
            // button_BNFilter_OK
            // 
            button_BNFilter_OK.FlatStyle = FlatStyle.Flat;
            button_BNFilter_OK.Font = new Font("Segoe UI", 10F);
            button_BNFilter_OK.ForeColor = Color.FromArgb(148, 255, 216);
            ...
            panel_BNFilter.Controls.Add(label_Filters_TenBN);
            panel_BNFilter.Controls.Add(label_Filters_MaTK);
            panel_BNFilter.Controls.Add(label_Filters_MaHSBA);
            ...
            panel_BNFilter.Controls.Add(textBox_Filters_TenBN);
            panel_BNFilter.Controls.Add(button_BNFilter_OK);
            panel_BNFilter.Controls.Add(textBox_Filters_MaBN);
            panel_BNFilter.Controls.Add(label_Filters);
            ...
            // panel_BNUpload
            // 
            panel_BNUpload.Anchor = AnchorStyles.Right;
            ...
            panel_BNUpload.Controls.Add(label8);
            panel_BNUpload.Controls.Add(textBox_BNUpload_Nam);
            panel_BNUpload.Controls.Add(label7);
            panel_BNUpload.Controls.Add(comboBox_BNUpload_Thang);
            panel_BNUpload.Controls.Add(label6);
            panel_BNUpload.Controls.Add(label5);
            panel_BNUpload.Controls.Add(textBox_BNUpload_Ngay);
            panel_BNUpload.Controls.Add(label4);
            panel_BNUpload.Controls.Add(label3);
            panel_BNUpload.Controls.Add(label2);
            panel_BNUpload.Controls.Add(textBox_BNUpload_Email);
            panel_BNUpload.Controls.Add(textBox_BNUpload_SDT);
            panel_BNUpload.Controls.Add(textBox_BNUpload_TenBN);
            panel_BNUpload.Controls.Add(button_Upload_OK);
            panel_BNUpload.Controls.Add(textBox_BNUpload_MaBN);
            panel_BNUpload.Controls.Add(label_BNUpload);
            panel_BNUpload.Location = new Point(1174, 84);
            panel_BNUpload.Name = "panel_BNUpload";
            panel_BNUpload.Size = new Size(416, 849);
            ...
            // pageButton_HSBATab
            // 
            pageButton_HSBATab.Anchor = AnchorStyles.Top;
            pageButton_HSBATab.BackColor = Color.FromArgb(57, 54, 70);
            pageButton_HSBATab.BorderColor = Color.PaleVioletRed;
            pageButton_HSBATab.BorderRadius = 40;
            pageButton_HSBATab.BorderSize = 0;
            pageButton_HSBATab.CustomText = "Hồ sơ bệnh án";
            pageButton_HSBATab.FlatAppearance.BorderSize = 0;
            pageButton_HSBATab.FlatStyle = FlatStyle.Flat;
            pageButton_HSBATab.Font = new Font("Segoe UI Semibold", 12F, FontStyle.Bold);
            pageButton_HSBATab.ForeColor = Color.FromArgb(193, 193, 193);
            pageButton_HSBATab.Icon = (Image)resources.GetObject("pageButton_HSBATab.Icon");
            pageButton_HSBATab.IconLocation = new Point(15, 13);
            pageButton_HSBATab.IconSize = new Size(34, 34);
            ...
            // pageButton_BNTab
            // 
            pageButton_BNTab.Anchor = AnchorStyles.Top;
            pageButton_BNTab.BackColor = Color.FromArgb(57, 54, 70);
            pageButton_BNTab.BorderColor = Color.PaleVioletRed;
            pageButton_BNTab.BorderRadius = 40;
            pageButton_BNTab.BorderSize = 0;
            pageButton_BNTab.CustomText = "Bệnh nhân";
            pageButton_BNTab.FlatAppearance.BorderSize = 0;
            pageButton_BNTab.FlatStyle = FlatStyle.Flat;
            pageButton_BNTab.Font = new Font("Segoe UI Semibold", 12F, FontStyle.Bold);
            pageButton_BNTab.ForeColor = Color.FromArgb(193, 193, 193);
            pageButton_BNTab.Icon = (Image)resources.GetObject("pageButton_BNTab.Icon");
            pageButton_BNTab.IconLocation = new Point(15, 15);
            pageButton_BNTab.IconSize = new Size(30, 30);
            ...
            // pageButton_TKTab
            // 
            pageButton_TKTab.Anchor = AnchorStyles.Top;
            pageButton_TKTab.BackColor = Color.FromArgb(57, 54, 70);
            pageButton_TKTab.BorderColor = Color.PaleVioletRed;
            pageButton_TKTab.BorderRadius = 40;
            pageButton_TKTab.BorderSize = 0;
            pageButton_TKTab.CustomText = "Tài khoản";
            pageButton_TKTab.FlatAppearance.BorderSize = 0;
            pageButton_TKTab.FlatStyle = FlatStyle.Flat;
            pageButton_TKTab.Font = new Font("Segoe UI Semibold", 12F, FontStyle.Bold);
            pageButton_TKTab.ForeColor = Color.FromArgb(193, 193, 193);
            pageButton_TKTab.Icon = (Image)resources.GetObject("pageButton_TKTab.Icon");
            pageButton_TKTab.IconLocation = new Point(15, 13);
            pageButton_TKTab.IconSize = new Size(34, 34);
            ...
            panel_TKUpload.Controls.Add(textBox_TKUpload_MaTK);
            panel_TKUpload.Controls.Add(label18);
            panel_TKUpload.Controls.Add(label15);
            panel_TKUpload.Controls.Add(label16);
            panel_TKUpload.Controls.Add(textBox_TKUpload_TenTK);
            panel_TKUpload.Controls.Add(button_TKUpload_OK);
            panel_TKUpload.Controls.Add(textBox_TKUpload_MaBN);
            panel_TKUpload.Controls.Add(label17);
            ...
            // 
            textBox_TKUpload_SDT.BackColor = Color.FromArgb(57, 54, 70);
            textBox_TKUpload_SDT.BorderStyle = BorderStyle.None;
            textBox_TKUpload_SDT.Font = new Font("Segoe UI Semilight", 12F);
            textBox_TKUpload_SDT.ForeColor = Color.FromArgb(244, 238, 224);
            ...
            label11.Location = new Point(25, 381);
            label11.Name = "label11";
            label11.Size = new Size(128, 28);
            label11.TabIndex = 27;
            label11.Text = "Số điện thoại";
            label11.TextAlign = ContentAlignment.BottomLeft;
            // 
            // textBox_TKUpload_MatKhau
            // 
            textBox_TKUpload_MatKhau.BackColor = Color.FromArgb(57, 54, 70);
            textBox_TKUpload_MatKhau.BorderStyle = BorderStyle.None;
            textBox_TKUpload_MatKhau.Font = new Font("Segoe UI Semilight", 12F);
            textBox_TKUpload_MatKhau.ForeColor = Color.FromArgb(244, 238, 224);
            ...
            label1.Location = new Point(25, 282);
            label1.Name = "label1";
            ...
            // 
            // textBox_TKUpload_MaTK
            // 
            textBox_TKUpload_MaTK.BackColor = Color.FromArgb(57, 54, 70);
            ...
            label15.Location = new Point(25, 183);
            label15.Name = "label15";
            label15.Size = new Size(127, 28);
            label15.TabIndex = 10;
            label15.Text = "Tên tài khoản";
            ...
            label16.Location = new Point(25, 84);
            label16.Name = "label16";
            label16.Size = new Size(137, 28);
            label16.TabIndex = 9;
            label16.Text = "Mã bệnh nhân";
            label16.TextAlign = ContentAlignment.BottomLeft;
            // 
            // textBox_TKUpload_TenTK
            // 
            textBox_TKUpload_TenTK.BackColor = Color.FromArgb(57, 54, 70);
            textBox_TKUpload_TenTK.BorderStyle = BorderStyle.None;
            textBox_TKUpload_TenTK.Font = new Font("Segoe UI Semilight", 12F);
            textBox_TKUpload_TenTK.ForeColor = Color.FromArgb(244, 238, 224);
            ...
            // 
            // textBox_TKUpload_MaBN
            // 
            textBox_TKUpload_MaBN.BackColor = Color.FromArgb(57, 54, 70);
            textBox_TKUpload_MaBN.BorderStyle = BorderStyle.None;
            textBox_TKUpload_MaBN.Font = new Font("Segoe UI Semilight", 12F);
            ...
            label17.Location = new Point(15, 8);
            ...
            // panel_HSBAUpload
            // 
            panel_HSBAUpload.Anchor = AnchorStyles.Right;
            ...
            panel_HSBAUpload.Controls.Add(label19);
            panel_HSBAUpload.Controls.Add(comboBox_HSBAUpload_Thang);
            panel_HSBAUpload.Controls.Add(label20);
            panel_HSBAUpload.Controls.Add(textBox_HSBAUpload_Ngay);
            panel_HSBAUpload.Controls.Add(label21);
            panel_HSBAUpload.Controls.Add(label22);
            panel_HSBAUpload.Controls.Add(label23);
            panel_HSBAUpload.Controls.Add(textBox_HSBAUpload_MaNV);
            panel_HSBAUpload.Controls.Add(button_HSBAUpload_OK);
            panel_HSBAUpload.Controls.Add(textBox_HSBAUpload_MaBN);
            panel_HSBAUpload.Controls.Add(label24);
            ...
            label12.Location = new Point(25, 381);
            ...
            // 
            textBox_HSBAUpload_MaHSBA.BackColor = Color.FromArgb(57, 54, 70);
            ...
            label13.TabIndex = 23;
            label13.Text = "Mã hồ sơ bệnh án";
            label13.TextAlign = ContentAlignment.BottomLeft;
            // 
            // textBox_HSBAUpload_Nam
            // 
            textBox_HSBAUpload_Nam.BackColor = Color.FromArgb(57, 54, 70);
            textBox_HSBAUpload_Nam.BorderStyle = BorderStyle.None;
            textBox_HSBAUpload_Nam.Font = new Font("Segoe UI Semilight", 12F);
            textBox_HSBAUpload_Nam.ForeColor = Color.FromArgb(244, 238, 224);
            ...
            comboBox_HSBAUpload_Thang.FormattingEnabled = true;
            comboBox_HSBAUpload_Thang.Items.AddRange(new object[] { "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec" });
            ...
            // 
            // textBox_HSBAUpload_Ngay
            // 
            textBox_HSBAUpload_Ngay.BackColor = Color.FromArgb(57, 54, 70);
            textBox_HSBAUpload_Ngay.BorderStyle = BorderStyle.None;
            textBox_HSBAUpload_Ngay.Font = new Font("Segoe UI Semilight", 12F);
            textBox_HSBAUpload_Ngay.ForeColor = Color.FromArgb(244, 238, 224);
            ...
            label22.Size = new Size(161, 28);
            label22.TabIndex = 10;
            label22.Text = "Mã nhân viên lập";
            ...
            label23.Location = new Point(25, 84);
            label23.Name = "label23";
            label23.Size = new Size(137, 28);
            label23.TabIndex = 9;
            label23.Text = "Mã bệnh nhân";
            label23.TextAlign = ContentAlignment.BottomLeft;
            // 
            // textBox_HSBAUpload_MaNV
            // 
            textBox_HSBAUpload_MaNV.BackColor = Color.FromArgb(57, 54, 70);
            textBox_HSBAUpload_MaNV.BorderStyle = BorderStyle.None;
            textBox_HSBAUpload_MaNV.Font = new Font("Segoe UI Semilight", 12F);
            ...
            // 
            button_HSBAUpload_OK.FlatStyle = FlatStyle.Flat;
            button_HSBAUpload_OK.Font = new Font("Segoe UI", 10F);
            button_HSBAUpload_OK.ForeColor = Color.FromArgb(148, 255, 216);
            ...
            // 
            // textBox_HSBAUpload_MaBN
            // 
            textBox_HSBAUpload_MaBN.BackColor = Color.FromArgb(57, 54, 70);
            textBox_HSBAUpload_MaBN.BorderStyle = BorderStyle.None;
            textBox_HSBAUpload_MaBN.Font = new Font("Segoe UI Semilight", 12F);
            ...
            panel_HSBAFilter.Controls.Add(textBox_HSBAFilter_Nam);
            panel_HSBAFilter.Controls.Add(comboBox_HSBAFilter_Thang);
            panel_HSBAFilter.Controls.Add(textBox_HSBAFilter_Ngay);
            panel_HSBAFilter.Controls.Add(comboBox_HSBAFilter_Operation);
            panel_HSBAFilter.Controls.Add(label25);
            panel_HSBAFilter.Controls.Add(label26);
            panel_HSBAFilter.Controls.Add(label29);
            panel_HSBAFilter.Controls.Add(label30);
            panel_HSBAFilter.Controls.Add(textBox_HSBAFilter_MaHSBA);
            panel_HSBAFilter.Controls.Add(textBox_HSBAFilter_SDT);
            panel_HSBAFilter.Controls.Add(textBox_HSBAFilter_Email);
            panel_HSBAFilter.Controls.Add(button_HSBAFilter_OK);
            panel_HSBAFilter.Controls.Add(textBox_HSBAFilter_MaBN);
            panel_HSBAFilter.Controls.Add(label31);
            ...
            label28.Location = new Point(230, 381);
            ...
            label32.ImageAlign = ContentAlignment.BottomCenter;
            label32.Location = new Point(125, 381);
            label32.Name = "label32";
            label32.Size = new Size(66, 28);
            label32.TabIndex = 30;
            label32.Text = "Tháng";
            ...
            label33.Location = new Point(25, 381);
            label33.Name = "label33";
            label33.Size = new Size(59, 28);
            label33.TabIndex = 29;
            label33.Text = "Ngày";
            label33.TextAlign = ContentAlignment.BottomLeft;
            // 
            // textBox_HSBAFilter_Nam
            // 
            textBox_HSBAFilter_Nam.BackColor = Color.FromArgb(57, 54, 70);
            textBox_HSBAFilter_Nam.BorderStyle = BorderStyle.None;
            textBox_HSBAFilter_Nam.Font = new Font("Segoe UI Semilight", 12F);
            textBox_HSBAFilter_Nam.ForeColor = Color.FromArgb(244, 238, 224);
            ...
            comboBox_HSBAFilter_Thang.FormattingEnabled = true;
            comboBox_HSBAFilter_Thang.Items.AddRange(new object[] { "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec" });
            ...
            // 
            textBox_HSBAFilter_Ngay.BackColor = Color.FromArgb(57, 54, 70);
            textBox_HSBAFilter_Ngay.BorderStyle = BorderStyle.None;
            textBox_HSBAFilter_Ngay.Font = new Font("Segoe UI Semilight", 12F);
            textBox_HSBAFilter_Ngay.ForeColor = Color.FromArgb(244, 238, 224);
            ...
            comboBox_HSBAFilter_Operation.FormattingEnabled = true;
            comboBox_HSBAFilter_Operation.Items.AddRange(new object[] { ">", "≥", "=", "≤", "<" });
            ...
            label25.ForeColor = Color.FromArgb(193, 193, 193);
            label25.Location = new Point(25, 282);
            label25.Name = "label25";
            label25.Size = new Size(128, 28);
            label25.TabIndex = 17;
            label25.Text = "Số điện thoại";
            ...
            label26.ForeColor = Color.FromArgb(193, 193, 193);
            label26.Location = new Point(25, 183);
            label26.Name = "label26";
            label26.Size = new Size(59, 28);
            label26.TabIndex = 16;
            label26.Text = "Email";
            ...
            label29.TabIndex = 13;
            label29.Text = "Mã hồ sơ bệnh án";
            ...
            label30.Location = new Point(25, 84);
            label30.Name = "label30";
            label30.Size = new Size(137, 28);
            label30.TabIndex = 12;
            label30.Text = "Mã bệnh nhân";
            label30.TextAlign = ContentAlignment.BottomLeft;
            // 
            // textBox_HSBAFilter_MaHSBA
            // 
            textBox_HSBAFilter_MaHSBA.BackColor = Color.FromArgb(57, 54, 70);
            ...
            // 
            textBox_HSBAFilter_SDT.BackColor = Color.FromArgb(57, 54, 70);
            textBox_HSBAFilter_SDT.BorderStyle = BorderStyle.None;
            textBox_HSBAFilter_SDT.Font = new Font("Segoe UI Semilight", 12F);
            textBox_HSBAFilter_SDT.ForeColor = Color.FromArgb(244, 238, 224);
            ...
            // 
            textBox_HSBAFilter_Email.BackColor = Color.FromArgb(57, 54, 70);
            textBox_HSBAFilter_Email.BorderStyle = BorderStyle.None;
            textBox_HSBAFilter_Email.Font = new Font("Segoe UI Semilight", 12F);
            textBox_HSBAFilter_Email.ForeColor = Color.FromArgb(244, 238, 224);
            ...
            // 
            button_HSBAFilter_OK.FlatStyle = FlatStyle.Flat;
            button_HSBAFilter_OK.Font = new Font("Segoe UI", 10F);
            button_HSBAFilter_OK.ForeColor = Color.FromArgb(148, 255, 216);
            ...
            // 
            // textBox_HSBAFilter_MaBN
            // 
            textBox_HSBAFilter_MaBN.BackColor = Color.FromArgb(57, 54, 70);
            textBox_HSBAFilter_MaBN.BorderStyle = BorderStyle.None;
            textBox_HSBAFilter_MaBN.Font = new Font("Segoe UI Semilight", 12F);
            ...
            label31.Location = new Point(15, 8);
            label31.Name = "label31";
            label31.Size = new Size(92, 38);
            label31.TabIndex = 2;
            label31.Text = "Filters";
            // 
            // panel_TKFilter
            // 
            ...
            panel_TKFilter.Controls.Add(textBox_TKFilter_Nam);
            panel_TKFilter.Controls.Add(comboBox_TKFilter_Thang);
            panel_TKFilter.Controls.Add(textBox_TKFilter_Ngay);
            panel_TKFilter.Controls.Add(comboBox_TKFilter_Operation);
            panel_TKFilter.Controls.Add(label38);
            panel_TKFilter.Controls.Add(label39);
            panel_TKFilter.Controls.Add(label40);
            panel_TKFilter.Controls.Add(label41);
            panel_TKFilter.Controls.Add(label42);
            panel_TKFilter.Controls.Add(textBox_TKFilter_MaTK);
            panel_TKFilter.Controls.Add(textBox_TKFilter_SDT);
            panel_TKFilter.Controls.Add(textBox_TKFilter_Email);
            panel_TKFilter.Controls.Add(textBox_TKFilter_TenTK);
            panel_TKFilter.Controls.Add(button_TKFilter_OK);
            panel_TKFilter.Controls.Add(textBox_TKFilter_MaBN);
            panel_TKFilter.Controls.Add(label43);
            ...
            label35.Location = new Point(230, 480);
            ...
            label36.Location = new Point(125, 480);
            ...
            label37.Location = new Point(25, 480);
            ...
            // 
            // textBox_TKFilter_Nam
            // 
            textBox_TKFilter_Nam.BackColor = Color.FromArgb(57, 54, 70);
            textBox_TKFilter_Nam.BorderStyle = BorderStyle.None;
            textBox_TKFilter_Nam.Font = new Font("Segoe UI Semilight", 12F);
            textBox_TKFilter_Nam.ForeColor = Color.FromArgb(244, 238, 224);
            ...
            comboBox_TKFilter_Thang.FormattingEnabled = true;
            comboBox_TKFilter_Thang.Items.AddRange(new object[] { "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec" });
            ...
            // 
            textBox_TKFilter_Ngay.BackColor = Color.FromArgb(57, 54, 70);
            textBox_TKFilter_Ngay.BorderStyle = BorderStyle.None;
            textBox_TKFilter_Ngay.Font = new Font("Segoe UI Semilight", 12F);
            textBox_TKFilter_Ngay.ForeColor = Color.FromArgb(244, 238, 224);
            ...
            comboBox_TKFilter_Operation.FormattingEnabled = true;
            comboBox_TKFilter_Operation.Items.AddRange(new object[] { ">", "≥", "=", "≤", "<" });
            ...
            label38.Location = new Point(25, 381);
            label38.Name = "label38";
            label38.Size = new Size(128, 28);
            label38.TabIndex = 17;
            label38.Text = "Số điện thoại";
            ...
            label39.ForeColor = Color.FromArgb(193, 193, 193);
            label39.Location = new Point(25, 282);
            label39.Name = "label39";
            label39.Size = new Size(59, 28);
            label39.TabIndex = 16;
            label39.Text = "Email";
            label39.TextAlign = ContentAlignment.BottomLeft;
            // 
            // label40
            // 
            ...
            label40.ForeColor = Color.FromArgb(193, 193, 193);
            label40.Location = new Point(25, 183);
            label40.Name = "label40";
            label40.Size = new Size(127, 28);
            label40.TabIndex = 15;
            label40.Text = "Tên tài khoản";
            label40.TextAlign = ContentAlignment.BottomLeft;
            // 
            // label41
            // 
            ...
            label41.TabIndex = 13;
            label41.Text = "Mã tài khoản";
            label41.TextAlign = ContentAlignment.BottomLeft;
            // 
            // label42
            // 
            ...
            label42.ForeColor = Color.FromArgb(193, 193, 193);
            label42.Location = new Point(25, 84);
            label42.Name = "label42";
            label42.Size = new Size(137, 28);
            label42.TabIndex = 12;
            label42.Text = "Mã bệnh nhân";
            label42.TextAlign = ContentAlignment.BottomLeft;
            // 
            // textBox_TKFilter_MaTK
            // 
            textBox_TKFilter_MaTK.BackColor = Color.FromArgb(57, 54, 70);
            ...
            // 
            textBox_TKFilter_SDT.BackColor = Color.FromArgb(57, 54, 70);
            textBox_TKFilter_SDT.BorderStyle = BorderStyle.None;
            textBox_TKFilter_SDT.Font = new Font("Segoe UI Semilight", 12F);
            textBox_TKFilter_SDT.ForeColor = Color.FromArgb(244, 238, 224);
            ...
            // 
            textBox_TKFilter_Email.BackColor = Color.FromArgb(57, 54, 70);
            textBox_TKFilter_Email.BorderStyle = BorderStyle.None;
            textBox_TKFilter_Email.Font = new Font("Segoe UI Semilight", 12F);
            textBox_TKFilter_Email.ForeColor = Color.FromArgb(244, 238, 224);
            ...
            // 
            textBox_TKFilter_TenTK.BackColor = Color.FromArgb(57, 54, 70);
            textBox_TKFilter_TenTK.BorderStyle = BorderStyle.None;
            textBox_TKFilter_TenTK.Font = new Font("Segoe UI Semilight", 12F);
            textBox_TKFilter_TenTK.ForeColor = Color.FromArgb(244, 238, 224);
            ...
            // button_TKFilter_OK
            // 
            button_TKFilter_OK.FlatStyle = FlatStyle.Flat;
            button_TKFilter_OK.Font = new Font("Segoe UI", 10F);
            button_TKFilter_OK.ForeColor = Color.FromArgb(148, 255, 216);
            ...
            // 
            // textBox_TKFilter_MaBN
            // 
            textBox_TKFilter_MaBN.BackColor = Color.FromArgb(57, 54, 70);
            textBox_TKFilter_MaBN.BorderStyle = BorderStyle.None;
            textBox_TKFilter_MaBN.Font = new Font("Segoe UI Semilight", 12F);
            ...
            label43.Location = new Point(15, 8);
            label43.Name = "label43";
            label43.Size = new Size(92, 38);
            label43.TabIndex = 2;
            ...
            panel_BNFilter.ResumeLayout(false);
            panel_BNFilter.PerformLayout();
            ...
            panel_HSBAUpload.ResumeLayout(false);
            panel_HSBAUpload.PerformLayout();
            panel_HSBAFilter.ResumeLayout(false);
        ...
        private Button button_BNFilter_OK;
        ...
        private TextBox textBox_TKUpload_TenTK;
        private Button button_TKUpload_OK;
        private TextBox textBox_TKUpload_MaBN;
        ...
        private ComboBox comboBox_HSBAUpload_Thang;
        private Label label20;
        private TextBox textBox_HSBAUpload_Ngay;
        private Label label21;
        private Label label22;
        private Label label23;
        private TextBox textBox_HSBAUpload_MaNV;
        ...
        private Button button_HSBAFilter_OK;
        private TextBox textBox_HSBAFilter_MaBN;
        private TextBox textBox_HSBA_Filter;
        ...
        private TextBox textBox_TKFilter_Nam;
        private ComboBox comboBox_TKFilter_Thang;
        private TextBox textBox_TKFilter_Ngay;
        private ComboBox comboBox_TKFilter_Operation;
        private Label label38;
        private Label label39;
        private Label label40;
        private Label label41;
        private Label label42;
        private TextBox textBox_TKFilter_MaTK;
        private TextBox textBox_TKFilter_SDT;
        private TextBox textBox_TKFilter_Email;
        private TextBox textBox_TKFilter_TenTK;
        private Button button_TKFilter_OK;
        private TextBox textBox_TKFilter_MaBN;
